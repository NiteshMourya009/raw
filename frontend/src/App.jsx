...
import { LinkedInLoginCallback, LinkedInSignupCallback } from "./pages/auth/LinkedInCallback";
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="linkedin-signup-callback" element={<LinkedInSignupCallback/>} />
    <Route path="/linkedin-login-callback" element={<LinkedInLoginCallback />} />  <Route path="linkedin-login-callback" element={<LinkedInSignupCallback/>} />
